fun main(){
    var countries= favCountries(listOf("Makkah","Madinah","Malaysia","Amsterdam","Azerbaijan","Singapore","Canada","Morocco","Italy","Berlin"))
    var heightAndAverage = heightOfPeople(listOf(2.3,1.49,1.76,1.88))
    println(heightAndAverage)
    var insan = Human("salma",22,1.45,47.5)
    ...
    println(individuals)
    var mundu = Human("Kirigo",22,1.49,53.5)
    var andu = Human("Rosemary",23,1.70,52.5)
